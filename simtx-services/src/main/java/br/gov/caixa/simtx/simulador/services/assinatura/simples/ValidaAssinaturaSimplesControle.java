...
public class ValidaAssinaturaSimplesControle extends Controle {

	private static final Logger logger = Logger.getLogger(ValidaAssinaturaSimplesControle.class);
