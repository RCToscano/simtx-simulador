...
public class ValidaAssinaturaSimplesV2Controle extends Controle {

	private static final Logger logger = Logger.getLogger(ValidaAssinaturaSimplesV2Controle.class);
