...
import br.gov.caixa.simtx.simulador.services.investimento.cancelamentoaplicacao.CancelamentoAplicacaoControle;
import br.gov.caixa.simtx.simulador.services.investimento.cancelamentoaplicacao.RequisicaoCancelamentoAplicacao;
...
public class CancelamentoResgateControle extends Controle {
	...
	public Response validarServico(@Context HttpServletRequest httpRequest, @PathParam("id_conta") String idConta, String json) {
		try {
			RequisicaoCancelamentoResgate requisicao = gson.fromJson(json, RequisicaoCancelamentoResgate.class);
