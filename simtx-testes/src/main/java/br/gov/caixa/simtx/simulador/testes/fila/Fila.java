package br.gov.caixa.simtx.simulador.testes.fila;
...
//	private Properties props = Reader.getProps();
	...
	public String publicar(String msg) throws JMSException {
		if (this.sender == null || this.session == null)
			throw new RuntimeException("Usar o metodo 'abrir' para abrir uma conexao");
...
//	}
	...
	public static Fila getFilaRequisicao(String host, String port, String manager, String channel, String queue) {
		try {
			return new Fila(host, port, manager, channel, queue).create();
		} 
		catch (Exception e) {
			logger.error(e);
		}
	...
	public static Fila getFilaResposta(String host, String port, String manager, String channel, String queue) {
		try {
			return new Fila(host, port, manager, channel, queue).create();
		} catch (Exception e) {
			logger.error(e);
