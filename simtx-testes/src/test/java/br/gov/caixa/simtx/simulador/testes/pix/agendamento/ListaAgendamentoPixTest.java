...
class ListaAgendamentoPixTest extends BaseTeste {
	...
	private static final String URI = "https://simtx-agendamento-des-esteiras.nprd2.caixa/agendamento/v1/contas/{id_conta}/agendamentos";
...
//				.getAccessToken();
	...
	public String executarRequisicao(String path, String token, String conta, MultivaluedMap<String, String> param) {
		if(UTILIZARHTTP) {
			...
			String jsonPagamento = recuperarJson(BASE_PATH_JSON.concat(PATH).concat("agendamento/lista/").concat(path));
